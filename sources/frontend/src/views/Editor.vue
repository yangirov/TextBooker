<template>
  <section>
    <el-tabs type="border-card" value="5">
      ...
      <el-tab-pane label="Templates" v-if="isAuth" class="full-wh" :lazy="true">
        <span slot="label">
          <i class="el-icon-picture"></i> {{ $t('tabs.template.name') }}
        </span>
        <TemplateGallery />
      </el-tab-pane>

      <el-tab-pane label="Settings" v-if="isAuth" class="full-wh" :lazy="true">
        <span slot="label">
      ...
      <el-tab-pane label="Pages" v-if="isAuth" class="full-wh" :lazy="true">
        <span slot="label">
      ...
      <el-tab-pane label="Blocks" v-if="isAuth" class="full-wh" :lazy="true">
        <span slot="label">
      ...
      <el-tab-pane label="Publish" v-if="isAuth" class="full-wh" :lazy="true">
        <span slot="label">
